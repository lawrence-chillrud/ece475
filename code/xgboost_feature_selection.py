...
if run_grid_search:
    ...
    joblib.dump(gs.best_estimator_, 'data/generated/models/xgboost_final.pkl')
    results_df.to_csv('data/generated/models/xgboost_results_df_final.csv', index=False)
...
for train_index, val_index in cv.split(X_train_val, y_train_val):
    ...
    for thresh in thresholds:
        ...
        # train model
        selection_model = xgb.XGBClassifier(**model.get_params())
